...
async def ai_chat(
    ...
    if settings.demo_mode and not settings.xai_api_key and not settings.openai_api_key:
        fallback = (
    ...
    context = {
        "portfolio": portfolio_summary.model_dump() if portfolio_summary else None,
